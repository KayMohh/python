...
SECRET_KEY = 'django-insecure-z5d))%p$t-d*&7=^(ihfw-v)^z0e4=$b=ee!)ikic5we&r4j&7'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'socialaccount.context_processors.socialaccoun',
            ],
        },
    },
]
...
SITE_ID = 2  # Required for django.contrib.sites
